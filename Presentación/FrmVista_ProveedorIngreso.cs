...
namespace Sistema.Presentacion
{
    public partial class FrmVista_ProveedorIngreso : Form
    {
        ...
        {
            Variable.IdProveedor = Convert.ToInt32(DgvListado.CurrentRow.Cells["ID"].Value);
            Variable.NombreProveedor = Convert.ToString(DgvListado.CurrentRow.Cells["Nombre"].Value);
            Variable.IdUsuario = Convert.ToInt32(DgvListado.CurrentRow.Cells["ID"].Value);
            this.Close();
